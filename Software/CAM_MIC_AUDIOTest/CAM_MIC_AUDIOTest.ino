...
- Probleme: Audio Widedergabe geht nur wenn keine Mikrofon Aufnahme... Compiler Fehler
*/
...
//  while(!Serial);
  ...
  #ifdef SPEAKER_CONNECTED //WIFI MUSS verbunden sein
    init_speaker();
...
void writeFile(fs::FS &fs, const char * path, uint8_t * data, size_t len){
  ...
  void init_speaker(void){
    ...
    USBSerial.print("Audio Speaker Ready");
  } 
